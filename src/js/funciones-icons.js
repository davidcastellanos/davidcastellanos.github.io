...
const maximizar = (event) => {
  let user =
    event.target.parentElement.parentElement.nextElementSibling.firstChild
      .nextSibling.textContent;
  let descripcion =
    event.target.parentElement.parentElement.nextElementSibling.firstChild
      .nextSibling.nextSibling.nextSibling.textContent;
  let pictureUrl =
  ...
  let imagen =
    iconModalFav.parentNode.parentNode.previousElementSibling.firstElementChild;
